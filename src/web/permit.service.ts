...
------WebKitFormBoundary7vxzlQ0hKVjjh5rw--`;
    ...
    await this.newOrderRequest(body, session_id, "----WebKitFormBoundary7vxzlQ0hKVjjh5rw");
  }
  ...
  private async permitAuto({
    ...
    const body = `------WebKitFormBoundaryBZgqw4oLEAmJRrGf
Content-Disposition: form-data; name="__EVENTTARGET"


------WebKitFormBoundaryBZgqw4oLEAmJRrGf
Content-Disposition: form-data; name="__EVENTARGUMENT"
...
------WebKitFormBoundaryBZgqw4oLEAmJRrGf--`;
    ...
    const session_id = await this.getSessionId();
    await this.newOrderRequest(body, session_id, "----WebKitFormBoundaryBZgqw4oLEAmJRrGf");
  }
